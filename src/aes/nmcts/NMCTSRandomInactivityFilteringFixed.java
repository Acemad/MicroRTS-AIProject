...
public class NMCTSRandomInactivityFilteringFixed extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public NMCTSRandomInactivityFilteringFixed(UnitTypeTable unitTypeTable, int maxAllowedInactions) {
        this(unitTypeTable);
     ...
     * @param unitTypeTable
     */
    public NMCTSRandomInactivityFilteringFixed(UnitTypeTable unitTypeTable) {
     ...
     */
    public NMCTSRandomInactivityFilteringFixed(int timeBudget, int iterationsBudget, int simulationTime, int maxDepth,
    ...
    @Override
    public AI clone() {
        return new NMCTSRandomInactivityFilteringFixed(TIME_BUDGET, ITERATIONS_BUDGET, simulationTime, maxDepth,
