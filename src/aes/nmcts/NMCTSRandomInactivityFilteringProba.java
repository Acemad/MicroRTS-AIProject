...
public class NMCTSRandomInactivityFilteringProba extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public NMCTSRandomInactivityFilteringProba(UnitTypeTable unitTypeTable, float allowProbability) {
        this(unitTypeTable);
     ...
     * @param unitTypeTable
     */
    public NMCTSRandomInactivityFilteringProba(UnitTypeTable unitTypeTable) {
     ...
     */
    public NMCTSRandomInactivityFilteringProba(int timeBudget, int iterationsBudget, int simulationTime, int maxDepth,
    ...
    @Override
    public AI clone() {
        return new NMCTSRandomInactivityFilteringProba(TIME_BUDGET, ITERATIONS_BUDGET, simulationTime, maxDepth,
