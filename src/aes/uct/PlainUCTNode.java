...
public class PlainUCTNode {
    ...
    private PlainUCTNode parent = null;
    private List<PlainUCTNode> children = null;
    private List<PlayerAction> actions = null;
    private PlayerActionGenerator actionGenerator = null;
//    private OrderedPlayerActionGenerator actionGenerator = null;
     ...
     * @throws Exception
     */
    public PlainUCTNode(GameState gameState, PlainUCTNode parent, int player) throws Exception {
     ...
     */
    public PlainUCTNode selectLeaf(int player, long cutOffTime, int depthLimit, double evaluationBound) throws Exception {
        ...
        for (PlainUCTNode child : children) {
     ...
     */
    public double childNodeUCBValue(PlainUCTNode node, double evaluationBound) {
    ...
    public PlainUCTNode getParent() {
        return parent;
    }

    public List<PlainUCTNode> getChildren() {
        return children;
    }
