...
public class UCTRandomPruningFixed extends AIWithComputationBudget implements InterruptibleAI {
    ...
    private UCTRandomPruningFixedNode tree = null;

    private int simulationTime;
    private int depthLimit;
    private int allowedActionsCount;
     ...
     */
    public UCTRandomPruningFixed(UnitTypeTable unitTypeTable) {
        this(100, -1, 100, 10, 10,
     ...
     * @param allowedActionsCount The probability of allowing inactive combinations.
     */
    public UCTRandomPruningFixed(UnitTypeTable unitTypeTable, int allowedActionsCount) {
        this(unitTypeTable);
     ...
     */
    public UCTRandomPruningFixed(int timeBudget, int iterationsBudget, int simulationTime, int depthLimit, int allowedActionsCount, AI playoutAI,
    ...
    public void startNewComputation(int player, GameState gameState) throws Exception {
        ...
        tree = new UCTRandomPruningFixedNode(gameState, null, player);
        this.player = player;
    ...
    private void monteCarloRun(long cutOffTime) throws Exception {
        ...
        UCTRandomPruningFixedNode selected = tree.selectLeaf(player, cutOffTime, depthLimit, evaluationBound, allowedActionsCount);
    ...
    public PlayerAction getBestActionSoFar() throws Exception {
        ...
        UCTRandomPruningFixedNode bestChild = null;
        for (int i = 0; i < tree.getChildren().size(); i++) {
            UCTRandomPruningFixedNode child = tree.getChildren().get(i);
    ...
    @Override
    public AI clone() {
        return new UCTRandomPruningFixed(TIME_BUDGET, ITERATIONS_BUDGET, simulationTime, depthLimit, allowedActionsCount, playoutAI, evaluationFunction);
    }
    ...
    public UCTRandomPruningFixedNode getTree() {
        return tree;
    }

    public void setAllowedActionsCount(int allowedActionsCount) {
        this.allowedActionsCount = allowedActionsCount;
    }

    public int getAllowedActionsCount() {
        return allowedActionsCount;
    }
}