...
public class UCTProbaInactionPruningNode {
...
//    private PlayerActionGenerator actionGenerator = null;
     ...
     * @throws Exception
     */
    public UCTProbaInactionPruningNode(GameState gameState, UCTProbaInactionPruningNode parent, int player) throws Exception {
     ...
     */
    public UCTProbaInactionPruningNode selectLeaf(int player, long cutOffTime, int depthLimit, double evaluationBound, float inactionAllowProbability) throws Exception {
...
//                System.out.println(action);
        ...
        for (UCTProbaInactionPruningNode child : children) {
        ...
        return bestChild.selectLeaf(player, cutOffTime, depthLimit, evaluationBound, inactionAllowProbability); // Recursively chose best node in each ply.
    }
     ...
     */
    public double childNodeUCBValue(UCTProbaInactionPruningNode node, double evaluationBound) {
    ...
    public UCTProbaInactionPruningNode getParent() {
        return parent;
    }

    public List<UCTProbaInactionPruningNode> getChildren() {
        return children;
    }
