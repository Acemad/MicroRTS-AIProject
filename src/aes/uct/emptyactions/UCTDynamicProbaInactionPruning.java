...
public class UCTDynamicProbaInactionPruning extends AIWithComputationBudget implements InterruptibleAI {
    ...
    private float inactionAllowProbabilityOutnumbers;
    private float inactionAllowProbabilityOutnumbered;
     ...
     */
    public UCTDynamicProbaInactionPruning(UnitTypeTable unitTypeTable) {
        this(100, -1, 100, 10, 0.5f, 0.9f,
     ...
     * @param inactionAllowProbabilityOutnumbers The probability of allowing inactive combinations.
     */
    public UCTDynamicProbaInactionPruning(UnitTypeTable unitTypeTable, float inactionAllowProbabilityOutnumbers,
                                          float inactionAllowProbabilityOutnumbered) {
        this(unitTypeTable);
        this.inactionAllowProbabilityOutnumbers = inactionAllowProbabilityOutnumbers;
        this.inactionAllowProbabilityOutnumbered = inactionAllowProbabilityOutnumbered;
    }
     ...
     */
    public UCTDynamicProbaInactionPruning(int timeBudget, int iterationsBudget, int simulationTime, int depthLimit,
                                          float inactionAllowProbabilityOutnumbers, float inactionAllowProbabilityOutnumbered,
...
//        System.out.println("P0 " + nbUnits[player] + "P1 " + nbUnits[1-player]);
        if (nbUnits[player] <= nbUnits[1 - player]) // if outnumbered
            inactionAllowProbability = inactionAllowProbabilityOutnumbered;
        else // if outnumbers
            inactionAllowProbability = inactionAllowProbabilityOutnumbers;
//        currentInactionAllowProbability = inactionAllowProbability;
    ...
    @Override
    public AI clone() {
        return new UCTDynamicProbaInactionPruning(TIME_BUDGET, ITERATIONS_BUDGET, simulationTime, depthLimit,
                inactionAllowProbabilityOutnumbers, inactionAllowProbabilityOutnumbered, playoutAI, evaluationFunction);
    }
    ...
    public void setInactionAllowProbabilityOutnumbers(float inactionAllowProbabilityOutnumbers) {
        this.inactionAllowProbabilityOutnumbers = inactionAllowProbabilityOutnumbers;
    }

    public float getInactionAllowProbabilityOutnumbers() {
        return inactionAllowProbabilityOutnumbers;
    }

    public void setInactionAllowProbabilityOutnumbered(float inactionAllowProbabilityOutnumbered) {
        this.inactionAllowProbabilityOutnumbered = inactionAllowProbabilityOutnumbered;
    }

    public float getInactionAllowProbabilityOutnumbered() {
        return inactionAllowProbabilityOutnumbered;
    }
