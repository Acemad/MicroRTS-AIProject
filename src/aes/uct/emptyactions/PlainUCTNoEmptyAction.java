...
public class PlainUCTNoEmptyAction extends AIWithComputationBudget implements InterruptibleAI {
    ...
    private PlainUCTNodeNoEmptyAction tree = null;
     ...
     */
    public PlainUCTNoEmptyAction(UnitTypeTable unitTypeTable) {
        this(100, -1, 100, 10,
     ...
     */
    public PlainUCTNoEmptyAction(int timeBudget, int iterationsBudget, int simulationTime, int depthLimit, AI playoutAI,
    ...
    public void startNewComputation(int player, GameState gameState) throws Exception {
        ...
        tree = new PlainUCTNodeNoEmptyAction(gameState, null, player);
        this.player = player;
    ...
    private void monteCarloRun(long cutOffTime) throws Exception {
        ...
        PlainUCTNodeNoEmptyAction selected = tree.selectLeaf(player, cutOffTime, depthLimit, evaluationBound);
    ...
    public PlayerAction getBestActionSoFar() throws Exception {
        ...
        for (int i = 0; i < tree.getChildren().size(); i++) {
            PlainUCTNodeNoEmptyAction child = tree.getChildren().get(i);
    ...
    @Override
    public AI clone() {
        return new PlainUCTNoEmptyAction(TIME_BUDGET, ITERATIONS_BUDGET, simulationTime, depthLimit, playoutAI, evaluationFunction);
    }
    ...
    public PlainUCTNodeNoEmptyAction getTree() {
        return tree;
    }
}